...
// ** ACTIVE CODE alert("Hey, it is " + haveToy + " that you can have the toy");

// Now: how we can use this variable + boolean inside with a while loop?
/**
while(!haveToy){
    haveToy = confirm("Pleaseeeeee can I have the toy?");
}
...
//the below do/while loop is the same as example above for while loop...see the difference?**
/**
var i = 10;
do {
    console.log("While loop iteration # " + i);
...
// multiply by two...until it is great than 100
