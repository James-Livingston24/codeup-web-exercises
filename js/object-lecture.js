...
// nested inside of the original object example:
var myCar = {
    make : "Pontiac",
    model : "GTO",
    year : 2006,
...
//alert("Hello, just FYI I own a " + myCar['make'] + " " + myCar.model);
...
//alert("By the way, my GTO is a " + myCarYear);
...
//myCar.features = ["heated/ventilated seats", "Sports package", "navigation"];
