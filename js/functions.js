// SECOND RUN THROUGH OF EXERCISES //
...
var newBillTotal = prompt("What is your bill total?");
var askTip = prompt("How much would you like to tip (please use percentage (i.e. .20 etc.)");
var totalBoth = alert("You should tip: " + newBillTotal * askTip);
...
function applyDiscount(price, discountPercentage) {
    ...
    return "Your price before discount: " + price + ", you have a discount of: " + discount;
}
console.log(applyDiscount(50, .15));
